...
AbstractPainter::AbstractPainter(Parameters &params,
                    const QString &name,
                    QSize size,
...
void AbstractPainter::SetName(const QString &name)
    { name_ = name; }

QSize AbstractPainter::GetSize() const noexcept
    { return image_.size(); }

const QString &AbstractPainter::GetName() const noexcept
    { return name_; }

const QImage &AbstractPainter::GetImage() const noexcept
    { return image_; }
