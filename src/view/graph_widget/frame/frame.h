...
class Frame : public QWidget {
 ...
 public:
  ...
  void AddGraph(const QString &name, const data_t &data, bool points = true,
                bool removeable = true);
  void AddGraph(const QString &name, data_t &&data, bool points = true,
                bool removeable = true);
  void AddGraph(const QString &name, bool points = true,
                bool removeable = true);
