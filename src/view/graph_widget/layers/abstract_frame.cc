...
void AbstractFrame::LineStyleHelper(QToolButton *button, QSpinBox *spin,
                                    QComboBox *box, QPen *pen) {
...
void AbstractFrame::PointStyleHelper(QToolButton *button, QSpinBox *spin,
                                     QComboBox *box, QPen *pen) {
  ToolAndSpinHelper(button, spin, pen);
...
void AbstractFrame::ToolAndSpinHelper(QToolButton *button, QSpinBox *spin,
                                      QPen *pen) {
...
void AbstractFrame::HideAndSettingsHelper(QPushButton *button, QFrame *settings,
                                          QLabel *lable, const QColor &color) {
  settings->setVisible(false);
  settings->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
  settings->setStyleSheet("QFrame#settings_frame { border: 1px solid " +
                          color.name() + "; }");
...
QString AbstractFrame::SaveImageDialog(QWidget *parent) {
  return QFileDialog::getSaveFileName(parent, "Save graph", "",
