...
void MainWindow::ApproximationInit()
{
    ...
    connect(ui_->weight_button, &QPushButton::clicked,
        this, &MainWindow::ApproximateWeightButton);
    connect(ui_->part5_button, &QPushButton::clicked,
        this, &MainWindow::Part5Button);
}
...
void MainWindow::ApproximateButton()
{
    ...
    auto data = facade_.LeastSquaresData(ui_->a_days_spin->value(), degree, weight_dialog_->Get());
