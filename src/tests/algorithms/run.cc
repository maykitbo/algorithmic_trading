...
INSTANTIATE_TEST_SUITE_P(InterpolationTest, FileTest,
                         testing::Combine(testing::Values(
                             "AAPL.csv", "ADBE.csv", "CVX_original.csv",
                             "CVX.csv", "CVX_w1.csv", "CVX_wr.csv", "CVX2.csv",
                             "DPZ.csv", "F.csv", "a45.csv", "a98.csv")));
