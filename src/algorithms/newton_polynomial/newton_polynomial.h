 ...
 *
 * This class provides methods to create a Newton polynomial interpolation from
 * a set of 2D points.
 */
class NewtonPolynomial {
 public:
   ...
   * interpolated points using Newton's Polynomial method.
   *
   ...
   * of interpolated points using Newton's Polynomial method.
   *
   ...
   * value using the Newton polynomial interpolation.
   *
